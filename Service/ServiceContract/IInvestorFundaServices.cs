...
namespace Service
{
    ...
    public interface IInvestorFundaServices
    {
        ...
        //[OperationContract]
        //[WebInvoke(BodyStyle = WebMessageBodyStyle.Wrapped, UriTemplate = "GetClientDashListDVal/{ClientID}", Method = "GET", ResponseFormat = WebMessageFormat.Json)]

        //Response<List<addClientDash>> GetClientDashListDVal(string ClientID);
        ...
        [OperationContract]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.Wrapped, UriTemplate = "addClientDashboard", Method = "POST", ResponseFormat = WebMessageFormat.Json)]
        Response<string> addClientDashboard(addClientDash request);
